	 ...
	 <div class="container-fluid">
	 	...
	 	<div class="row">
	 		...
	 		<div class="col-sm-10">
	 			...
	 			<ul>
	 				<li>
	 					<c:if test="${requestScope.books!=0}">
	 						<b>Books :</b>
	 						<c:out value="${requestScope.books}"></c:out>
	 					</c:if>
	 				</li>
	 				<li>
	 					<c:if test="${requestScope.authors!=0}">
	 						<b>Authors :</b>
	 						<c:out value="${requestScope.authors}"></c:out>
	 					</c:if>
	 				</li>
	 				<li>
	 					<c:if test="${requestScope.genres!=0}">
	 						<b>Genres :</b>
	 						<c:out value="${requestScope.genres}"></c:out>
	 					</c:if>
	 				</li>
